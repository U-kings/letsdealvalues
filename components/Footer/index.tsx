...
const Footer = () => {
  ...
  return (
    <footer
      className="wow fadeInUp relative z-10 bg-[#ffffff] pt-20 lg:pt-25"
      data-wow-delay=".15s"
    >
            ...
            <div className="mb-10 w-full">
              ...
              <div className="-mx-3 flex items-center">
                <Link
                  ...
                  href="https://www.facebook.com/profile.php?id=61590180895354"
                ...
                <Link
                  aria-label="social link"
                  href="https://www.instagram.com/letsdealvalues"
                  className="px-3 text-black font-medium hover:text-black"
                  target="_blank"
                >
                  <svg
                ...
                >
                  <Image
                    src="/whatsapp_business.svg"
                    alt="whatsapp_business"
                    width={28}
                    height={28}
                  />
                  {/* <svg
                ...
                {/* <Link
                  aria-label="social link"
                  href="https://www.linkedin.com/in/let-s-deal-values-88a50b410/?isSelfProfile=true"
                  className="px-3 text-black font-medium hover:text-black"
                  target="_blank"
                >
                  <svg
      ...
      <Certificates dialog={dialog} setDialog={setDialog} />

      <Dialog isOpen={isOpen} onOpenChange={setIsOpen}>
        <DialogOverlay
          isDismissable
          className={`z-999 ${dialog === 1 ? "block" : "hidden"}`}
        >
              ...
              {/* <object
                          ...
                          >
                            <p>
                              ...
                              <a href="https://heyzine.com/flip-book/7ec31e732b.html">Download the PDF</a>.
                            </p>
                          </object> */}
            </div>
            {/* <DialogFooter>
        ...
        <div className="mt-0 border-t border-[#8890A4]/40 py-8 lg:mt-0">
          {/* <div className="mt-12 border-t border-[#8890A4]/40 py-8 lg:mt-15"> */}
          <div className="container">
              ...
              <div className="w-full px-4 md:w-1/3 lg:w-1/2">
                <div className="my-1 flex justify-center md:justify-end">
                  <p className="text-base text-black">
                    Copyright © 2026 Let&apos;s Deal Values Services. All rights
                    reserved.
