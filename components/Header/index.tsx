          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex items-center justify-between px-4">
              <div>
                ...
                <nav
                  id="navbarCollapse"
                  className={`navbar absolute right-0 z-30 w-62.5 rounded border-[.5px] border-body-color/50 bg-white px-6 py-4 duration-300 dark:border-body-color/20 dark:bg-dark-2 lg:visible lg:static lg:w-auto lg:border-none lg:bg-transparent! lg:p-0 lg:opacity-100 lg:dark:bg-transparent ${navbarOpen
                    ...
                    {menuData.map((menuItem, index) =>
                      menuItem.path ? (
                        ...
                        <li className="submenu-item group relative" key={index}>
                          ...
                          <div
                            className={`submenu relative left-0 top-full w-62.5 rounded-sm bg-white p-4 transition-[top] duration-300 group-hover:opacity-100 dark:bg-dark-2 lg:invisible lg:absolute lg:top-[110%] lg:block lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full ${openIndex === index ? "-left-6.25!" : "hidden"
                              }`}
                          >
                             {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
